...
inline bool operator==(const ThreeBodyStorageChannel &a, const ThreeBodyStorageChannel &b) { return (a.ch_bra == b.ch_bra) && (a.ch_ket == b.ch_ket); }

struct ThreeBodyStorageChannelHash
{
    size_t operator()(const ThreeBodyStorageChannel &ch) const { return hash_combine(ch.ch_bra, ch.ch_ket); }
};
