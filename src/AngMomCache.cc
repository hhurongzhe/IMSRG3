...
static inline std::size_t Dim1BFromJJ1BMax(int jj_1b_max) { return JJ1BToIndex(jj_1b_max) + 1; }

static inline std::size_t Dim2BFromJJ1BMax(int jj_1b_max) { return J2BToIndex((jj_1b_max + jj_1b_max) / 2) + 1; }
...
SixJCache_112112::SixJCache_112112(const int jj_1b_max) : jj_1_max_(jj_1b_max), dim_1_(Dim1BFromJJ1BMax(jj_1_max_)), dim_2_(Dim2BFromJJ1BMax(jj_1_max_)), six_js_(GenerateSixJCache(jj_1_max_, dim_1_, dim_2_)) {}
