...
namespace imsrg_util
{
 ...
 Operator OperatorFromString(ModelSpace& modelspace, std::string opname )
 {
      ...
      else if (opname == "QdotQ" or opname == "QdotQm") theop = QdotQ_Op(modelspace,2,1,1);
      else if (opname == "QdotQp")        theop = QdotQ_Op(modelspace,2,1,0);
      else if (opname == "QdotQn")        theop = QdotQ_Op(modelspace,2,0,1);
      else if (opname == "QdotQE3")       theop = QdotQ_Op(modelspace,3,1,0);
