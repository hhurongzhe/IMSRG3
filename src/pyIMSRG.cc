...
PYBIND11_MODULE(pyIMSRG, m)
{
      ...
      py::class_<ModelSpace>(m, "ModelSpace")
          ...
          .def("SetLmax3", &ModelSpace::SetLmax3)
          ...
          .def("SetOccNat3Cut", &ModelSpace::SetOccNat3Cut)
...
//          .def("SetE3max", &Operator::SetE3max)
      ...
      py::class_<TwoBodyME>(m, "TwoBodyME")
          ...
          .def("IsReduced", &TwoBodyME::IsReduced)
          .def(py::self *= double())
          .def(double() * py::self)
          .def(py::self * double())
      ...
      py::class_<ThreeBodyME>(m, "ThreeBodyME")
          ...
          .def("IsReduced", &ThreeBodyME::IsReduced)
      ...
      py::class_<ReadWrite>(m, "ReadWrite")
          .def(py::init<>())
          .def_readwrite("File3N", &ReadWrite::File3N)
          ...
          .def("WriteOperator", &ReadWrite::WriteOperator, py::arg("op"), py::arg("filename"), py::arg("CHOP") = 1e-9)
          ...
          .def("WriteTokyoFull", &ReadWrite::WriteTokyoFull, py::arg("op"), py::arg("filename"))
