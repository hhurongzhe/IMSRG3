    ...
    for (int ich = 0; ich < nch; ich++)
    {
        ...
        for (int ibra = 0; ibra < nbras; ibra++)
        {
            ...
            for (int iket = ketmin; iket < nkets; iket++)
            {
                ...
                int Jpmin = std::min(std::max(std::abs(oi.j2 - ol.j2), std::abs(oj.j2 - ok.j2)), std::max(std::abs(oj.j2 - ol.j2), std::abs(oi.j2 - ok.j2))) / 2;
                int Jpmax = std::max(std::min(oi.j2 + ol.j2, oj.j2 + ok.j2), std::min(oj.j2 + ol.j2, oi.j2 + ok.j2)) / 2;
                                ...
                                for (int twoJp = twoJp_min; twoJp <= twoJp_max; twoJp += 2)
                                {
                                    ...
                                    for (int twoJpp = twoJpp_min; twoJpp <= twoJpp_max; twoJpp += 2)
                                    {
                                        ...
                                        zijkl += symmetry_factor * hatfactor * occupation_factor *
                                                 (1 * phase1 * ninej1 * xabicdl * ycdjabk + 1 * phase2 * ninej2 * xabjcdl * ycdiabk // i<->j
                        ...
                        for (int tz2a : {-1, 1})
                        {
                            ...
                            for (int J2p = J2p_min; J2p <= J2p_max; J2p++)
                            {
                                ...
                                for (int j2a = j2a_min; j2a <= j2a_max; j2a += 2)
                                {
                                    ...
                                    {
                                        sixj = j2a < twoJ ? Z.modelspace->GetSixJ(j6, ja, J1p, j3, 0.5 * twoJ, J2p) : Z.modelspace->GetSixJ(j6, 0.5 * twoJ, J2p, j3, ja, J1p);
                                    }
    ...
    for (auto &iter : Z.TwoBody.MatEl)
    {
        ...
        for (size_t ibra = 0; ibra < nbras; ibra++)
        {
            ...
            for (size_t iket = 0; iket < nkets; iket++)
            {
                ...
                std::vector<int> phases = {1, -AngMom::phase((op.j2 + oq.j2) / 2 - J1), -AngMom::phase((oR.j2 + os.j2) / 2 - J2), AngMom::phase((op.j2 + oq.j2) / 2 - J1) * AngMom::phase((oR.j2 + os.j2) / 2 - J2)};
                ...
                for (int iperm = 0; iperm < 4; iperm++)
                {
                    ...
                    for (int J3 = J3min; J3 <= J3max; J3++)
                    {
                        for (int J4 = J4min; J4 <= J4max; J4++)
                        {
                            ...
                            if (ch_bra == 1)
                            {
                                std::cout << __func__ << " " << __LINE__ << " channel J = " << tbc_bra.J << "  J3,J4 " << J3 << " " << J4 << " iperm " << iperm << " : " << phaseperm << " * " << sqrt((2 * J1 + 1) * (2 * J2 + 1) * (2 * J3 + 1) * (2 * J4 + 1)) << " * " << ninej << " * " << AngMom::phase((o2.j2 + o4.j2) / 2 + J2 + J4) << " * " << Zbar_1432 << " (<-Zbar_1432, zpqrs ->)  " << zpqrs << std::endl;
                            }
                        } // for J4
                    } // for J3
                } // for iperm
                        ...
                        for (size_t a : Z.modelspace->all_orbits)
                        {
                            ...
                            for (int J2p = J2p_min; J2p <= J2p_max; J2p++)
                            {
                                ...
                                for (int J3 = J3_min; J3 <= J3_max; J3++)
                                {
                                    ...
                                    sixj_1 = AngMom::SixJ(o3.j2 / 2., j2a / 2., J3, o6.j2 / 2., twoj1 / 2., J1p);
                                    sixj_2 = AngMom::SixJ(J3, J2p, Lambda, twoj2 / 2., twoj1 / 2., o6.j2 / 2.);
                                ...
                                for (int J3 = J3_min; J3 <= J3_max; J3++)
                                {
                                    if (J3 + J1p < Lambda or std::abs(J3 - J1p) > Lambda)
                                        continue;
                                    double sixj_1, sixj_2;
                                    sixj_1 = AngMom::SixJ(o6.j2 / 2., j2a / 2., J3, o3.j2 / 2., twoj2 / 2., J2p);
                                    sixj_2 = AngMom::SixJ(J3, J1p, Lambda, twoj1 / 2., twoj2 / 2., o3.j2 / 2.);
                        ...
                        for (size_t d : Z.modelspace->all_orbits)
                        {
                            ...
                            for (int J1 = J1min; J1 <= J1max; J1++)
                            {
                                ...
                                for (int twoj1 = twoj1min; twoj1 <= twoj1max; twoj1 += 2)
                                {
                                    ...
                                    {
                                        double sixj = AngMom::SixJ(oi.j2 / 2., oj.j2 / 2., Lambda, twoj2 / 2., twoj1 / 2., J1);
                            ...
                            for (int J1 = J1min; J1 <= J1max; J1++)
                            {
                                ...
                                for (int J2 = J2min; J2 <= J2max; J2++)
                                {
                                    ...
                                    for (int twoj1 = twoj1min; twoj1 <= twoj1max; twoj1 += 2)
                                    {
                                        double sixj = AngMom::SixJ(Lambda, J2, J1, twoj1 / 2., oi.j2 / 2., oj.j2 / 2.);
                                    ...
                                    for (int twoj1 = twoj1min; twoj1 <= twoj1max; twoj1 += 2)
                                    {
                                        double sixj = AngMom::SixJ(Lambda, J2, J1, twoj1 / 2., oj.j2 / 2., oi.j2 / 2.);
                            ...
                            if ((xcjab_good) and (std::abs(oj.j2 - oc.j2) <= 2 * Jab) and (oj.j2 + oc.j2 >= 2 * Jab))
                            {
                                ...
                                for (int twoj1 = twoj1_min; twoj1 <= twoj1_max; twoj1 += 2)
                                {
                                    for (int twoj2 = twoj2_min; twoj2 <= twoj2_max; twoj2 += 2)
                                    {
                                        ...
                                        double sixj = AngMom::SixJ(oi.j2 / 2., oj.j2 / 2., J1, oc.j2 / 2., twoj1 / 2., Jab);
                                        sixj *= AngMom::SixJ(Lambda, J1, J2, oc.j2 / 2., twoj2 / 2., twoj1 / 2.);
                            ...
                            if ((xciab_good) and (std::abs(oi.j2 - oc.j2) <= 2 * Jab) and (oi.j2 + oc.j2 >= 2 * Jab))
                            {
                                ...
                                for (int twoj1 = twoj1_min; twoj1 <= twoj1_max; twoj1 += 2)
                                {
                                    for (int twoj2 = twoj2_min; twoj2 <= twoj2_max; twoj2 += 2)
                                    {
                                        ...
                                        double sixj = AngMom::SixJ(oj.j2 / 2., oi.j2 / 2., J1, oc.j2 / 2., twoj1 / 2., Jab);
                                        sixj *= AngMom::SixJ(Lambda, J1, J2, oc.j2 / 2., twoj2 / 2., twoj1 / 2.);
                                ...
                                for (int twoj1 = twoj1_min; twoj1 <= twoj1_max; twoj1 += 2)
                                {
                                    ...
                                    for (int twoj2 = twoj2_min; twoj2 <= twoj2_max; twoj2 += 2)
                                    {
                                        ...
                                        for (int J3 = J3min; J3 <= J3max; J3++)
                                        {
                                            ...
                                            double sixj = AngMom::SixJ(Lambda, Jab, J3, oc.j2 / 2., oj.j2 / 2., twoj2 / 2.);
                                            sixj *= AngMom::SixJ(oc.j2 / 2., twoj1 / 2., J2, oi.j2 / 2., twoj2 / 2., Jab);
                                            sixj *= AngMom::SixJ(J1, Lambda, J2, twoj2 / 2., oi.j2 / 2., oj.j2 / 2.);
                                ...
                                for (int twoj1 = twoj1_min; twoj1 <= twoj1_max; twoj1 += 2)
                                {
                                    ...
                                    for (int twoj2 = twoj2_min; twoj2 <= twoj2_max; twoj2 += 2)
                                    {
                                        ...
                                        for (int J3 = J3min; J3 <= J3max; J3++)
                                        {
                                            ...
                                            double sixj = AngMom::SixJ(Lambda, Jab, J3, oc.j2 / 2., oi.j2 / 2., twoj2 / 2.);

                                            sixj *= AngMom::SixJ(oc.j2 / 2., twoj1 / 2., J2, oj.j2 / 2., twoj2 / 2., Jab);

                                            sixj *= AngMom::SixJ(J1, Lambda, J2, twoj2 / 2., oj.j2 / 2., oi.j2 / 2.);
                            ...
                            if ((xabcl_good) and (std::abs(ol.j2 - oc.j2) <= 2 * Jab) and (ol.j2 + oc.j2 >= 2 * Jab))
                            {
                                ...
                                for (int twoj1 = twoj1_min; twoj1 <= twoj1_max; twoj1 += 2)
                                {
                                    for (int twoj2 = twoj2_min; twoj2 <= twoj2_max; twoj2 += 2)
                                    {
                                        ...
                                        double sixj = AngMom::SixJ(J2, Lambda, J1, twoj1 / 2., oc.j2 / 2., twoj2 / 2.);
                                        sixj *= AngMom::SixJ(ok.j2 / 2., ol.j2 / 2., J2, oc.j2 / 2., twoj2 / 2., Jab);
                            ...
                            if ((xabck_good) and (std::abs(ok.j2 - oc.j2) <= 2 * Jab) and (ok.j2 + oc.j2 >= 2 * Jab))
                            {
                                ...
                                for (int twoj1 = twoj1_min; twoj1 <= twoj1_max; twoj1 += 2)
                                {
                                    for (int twoj2 = twoj2_min; twoj2 <= twoj2_max; twoj2 += 2)
                                    {
                                        ...
                                        double sixj = AngMom::SixJ(J2, Lambda, J1, twoj1 / 2., oc.j2 / 2., twoj2 / 2.);
                                        sixj *= AngMom::SixJ(ol.j2 / 2., ok.j2 / 2., J2, oc.j2 / 2., twoj2 / 2., Jab);
                                ...
                                for (int twoj1 = twoj1_min; twoj1 <= twoj1_max; twoj1 += 2)
                                {
                                    ...
                                    for (int twoj2 = twoj2_min; twoj2 <= twoj2_max; twoj2 += 2)
                                    {
                                        ...
                                        for (int J4 = J4min; J4 <= J4max; J4 += 1)
                                        {
                                            ...
                                            double sixj = AngMom::SixJ(oc.j2 / 2., twoj1 / 2., J1, ok.j2 / 2., twoj2 / 2., Jab);
                                            sixj *= AngMom::SixJ(Lambda, Jab, J4, oc.j2 / 2., ol.j2 / 2., twoj2 / 2.);
                                            sixj *= AngMom::SixJ(J2, J1, Lambda, twoj2 / 2., ol.j2 / 2., ok.j2 / 2.);
                                ...
                                for (int twoj1 = twoj1_min; twoj1 <= twoj1_max; twoj1 += 2)
                                {
                                    ...
                                    for (int twoj2 = twoj2_min; twoj2 <= twoj2_max; twoj2 += 2)
                                    {
                                        ...
                                        for (int J4 = J4min; J4 <= J4max; J4 += 1)
                                        {
                                            ...
                                            double sixj = AngMom::SixJ(oc.j2 / 2., twoj1 / 2., J1, ol.j2 / 2., twoj2 / 2., Jab);
                                            sixj *= AngMom::SixJ(Lambda, Jab, J4, oc.j2 / 2., ok.j2 / 2., twoj2 / 2.);
                                            sixj *= AngMom::SixJ(J2, J1, Lambda, twoj2 / 2., ok.j2 / 2., ol.j2 / 2.);
    ...
    for (size_t ich = 0; ich < n_bra_ket_ch; ich++)
    {
        ...
        for (size_t iket = ket_min; iket < nkets; iket++)
        {
            ...
            for (auto a : Y.GetOneBodyChannel(ok.l, ok.j2, ok.tz2))
            {
                ...
                double sixj = AngMom::SixJ(ok.j2 / 2., oa.j2 / 2., Lambda, twoj2 / 2., twoj1 / 2., Jij);
            ...
            for (auto a : X.GetOneBodyChannel(oi.l, oi.j2, oi.tz2))
            {
                ...
                for (int J3 = J3min; J3 <= J3max; J3++)
                {
                    ...
                    double sixj = AngMom::SixJ(oi.j2 / 2., oj.j2 / 2., Jij, ok.j2 / 2., twoj1 / 2., J3);
            ...
            for (auto a : Y.GetOneBodyChannel(oi.l, oi.j2, oi.tz2))
            {
                ...
                for (int J3 = J3min; J3 <= J3max; J3++)
                {
                    ...
                    double sixj = AngMom::SixJ(twoj2 / 2., oa.j2 / 2., J3, oi.j2 / 2., twoj1 / 2., Lambda);
                    sixj *= AngMom::SixJ(oi.j2 / 2., oj.j2 / 2., Jij, ok.j2 / 2., twoj1 / 2., J3);
            ...
            for (auto a : X.GetOneBodyChannel(oj.l, oj.j2, oj.tz2))
            {
                ...
                for (int J3 = J3min; J3 <= J3max; J3++)
                {
                    ...
                    double sixj = AngMom::SixJ(oj.j2 / 2., oi.j2 / 2., Jij, ok.j2 / 2., twoj1 / 2., J3);
            ...
            for (auto a : Y.GetOneBodyChannel(oj.l, oj.j2, oj.tz2))
            {
                ...
                {
                    double hatfactor = sqrt((2 * Jij + 1) * (2 * J3 + 1) * (twoj1 + 1) * (twoj2 + 1));
                    double sixj = AngMom::SixJ(twoj2 / 2., oa.j2 / 2., J3, oj.j2 / 2., twoj1 / 2., Lambda);
                    sixj *= AngMom::SixJ(oj.j2 / 2., oi.j2 / 2., Jij, ok.j2 / 2., twoj1 / 2., J3);
            ...
            for (auto a : Y.GetOneBodyChannel(on.l, on.j2, on.tz2))
            {
                ...
                double hatfactor = sqrt((twoj1 + 1) * (twoj2 + 1));
                double sixj = AngMom::SixJ(on.j2 / 2., oa.j2 / 2., Lambda, twoj1 / 2., twoj2 / 2., Jlm);
            ...
            for (auto a : X.GetOneBodyChannel(ol.l, ol.j2, ol.tz2))
            {
                ...
                for (int J3 = J3min; J3 <= J3max; J3++)
                {
                    ...
                    double sixj = AngMom::SixJ(ol.j2 / 2., om.j2 / 2., Jlm, on.j2 / 2., twoj2 / 2., J3);
            ...
            for (auto a : Y.GetOneBodyChannel(ol.l, ol.j2, ol.tz2))
            {
                ...
                for (int J3 = J3min; J3 <= J3max; J3++)
                {
                    ...
                    double sixj = AngMom::SixJ(on.j2 / 2., om.j2 / 2., J3, ol.j2 / 2., twoj2 / 2., Jlm);
                    sixj *= AngMom::SixJ(ol.j2 / 2., oa.j2 / 2., Lambda, twoj1 / 2., twoj2 / 2., J3);
            ...
            for (auto a : X.GetOneBodyChannel(om.l, om.j2, om.tz2))
            {
                ...
                for (int J3 = J3min; J3 <= J3max; J3++)
                {
                    ...
                    double sixj = AngMom::SixJ(om.j2 / 2., ol.j2 / 2., Jlm, on.j2 / 2., twoj2 / 2., J3);
            ...
            for (auto a : Y.GetOneBodyChannel(om.l, om.j2, om.tz2))
            {
                ...
                for (int J3 = J3min; J3 <= J3max; J3++)
                {
                    ...
                    double sixj = AngMom::SixJ(on.j2 / 2., ol.j2 / 2., J3, om.j2 / 2., twoj2 / 2., Jlm);
                    sixj *= AngMom::SixJ(om.j2 / 2., oa.j2 / 2., Lambda, twoj1 / 2., twoj2 / 2., J3);
                    ...
                    for (size_t b : Z.modelspace->all_orbits)
                    {
                        ...
                        if (std::abs(xab) > 1e-8)
                            for (int twoj1 = twoj1min; twoj1 <= twoj1max; twoj1 += 2)
                            {
                                for (int twoj2 = twoj2min; twoj2 <= twoj2max; twoj2 += 2)
                                {
                                    ...
                                    double hatfactor = sqrt((twoj1 + 1) * (twoj2 + 1));
                                    double sixj = AngMom::SixJ(Lambda, J1, J2, oa.j2 / 2., twoj2 / 2., twoj1 / 2.);
                        ...
                        if (std::abs(yab) > 1e-8)
                            for (int twoj1 = twoj1min; twoj1 <= twoj1max; twoj1 += 2)
                            {
                                ...
                                double sixj = AngMom::SixJ(J2, Lambda, J1, ob.j2 / 2., twoj1 / 2., oa.j2 / 2.);
                                ...
                                for (int J3 = J3min; J3 <= J3max; J3++)
                                {
                                    ...
                                    for (int twoj1 = twoj1min; twoj1 <= twoj1max; twoj1 += 2)
                                    {
                                        for (int twoj2 = twoj2min; twoj2 <= twoj2max; twoj2 += 2)
                                        {
                                            ...
                                            double hatfactor = sqrt((twoj1 + 1) * (twoj2 + 1));
                                            double sixj = AngMom::SixJ(J1, J2, Lambda, twoj2 / 2., twoj1 / 2., od.j2 / 2.);
                                            // Eq.(7.1)
                            ...
                            for (auto &e : Z.modelspace->all_orbits)
                            {
                                ...
                                for (int J0 = J0min; J0 <= J0max; J0++)
                                {
                                    for (int J1 = J1min; J1 <= J1max; J1++)
                                    {
                                        ...
                                        {
                                            std::cout << " I " << a << " " << b << " " << c << " " << d << "  " << J0 << " " << J1 << "   " << (2 * J0 + 1) * (2 * J1 + 1) / (od.j2 + 1.0) * occfactor * Eta.TwoBody.GetTBME_J(J0, J0, b, d, a, c) * Eta.TwoBody.GetTBME_J(J0, J0, a, c, b, e) * Gamma.TwoBody.GetTBME_J(J1, J1, e, p, d, q) << std::endl;
                                        }
                                    }
                                } // J0
                            }
                                    ...
                                    for (int J1 = J1min; J1 <= J1max; J1++)
                                    {
                                        for (int J2 = J2min; J2 <= J2max; J2++)
                                        {
                                            for (int J3 = J3min; J3 <= J3max; J3++)
                                            {
                                                ...
                                                if (p == orbit_print and q == orbit_print)
                                                {
                                                    std::cout << " IIa " << a << " " << b << " " << c << " " << d << "  " << J0 << " " << J1 << "   " << phasefactor * (2 * J0 + 1) * (2 * J1 + 1) * (2 * J2 + 1) * (2 * J3 + 1) * sixj * occfactor * Eta.TwoBody.GetTBME_J(J0, J0, b, d, a, c) * Eta.TwoBody.GetTBME_J(J1, J1, c, p, d, e) * Gamma.TwoBody.GetTBME_J(J2, J2, a, e, b, q) << std::endl;
                                                }
                                            }
                                        }
                                    }
                        ...
                        for (auto &d : Z.modelspace->all_orbits)
                        {
                            ...
                            for (auto &e : Z.modelspace->all_orbits)
                            {
                                ...
                                for (int J0 = J0min; J0 <= J0max; J0++)
                                {
                                    ...
                                    if (p == orbit_print and q == orbit_print)
                                    {
                                        std::cout << " IIb " << a << " " << b << " " << c << " " << d << "  " << e << " " << J0 << "   " << (2 * J0 + 1) * occfactor * Eta.TwoBody.GetTBME_J(J0, J0, b, e, a, d) * Eta.TwoBody.GetTBME_J(J0, J0, c, p, b, e) * Gamma.TwoBody.GetTBME_J(J0, J0, a, d, c, q) << std::endl;
                                    }
                                    ...
                                    for (int J1 = J1min; J1 <= J1max; J1++)
                                    {
                                        for (int J2 = J2min; J2 <= J2max; J2++)
                                        {
                                            for (int J3 = J3min; J3 <= J3max; J3++)
                                            {
                                                ...
                                                if (p == orbit_print and q == orbit_print)
                                                {
                                                    std::cout << " IIc " << a << " " << b << " " << c << " " << d << "  " << J0 << " " << J1 << "   " << (2 * J0 + 1) * (2 * J1 + 1) * (2 * J2 + 1) * (2 * J3 + 1) * sixj * occfactor * Eta.TwoBody.GetTBME_J(J0, J0, b, e, d, a) * Eta.TwoBody.GetTBME_J(J1, J1, c, a, b, q) * Gamma.TwoBody.GetTBME_J(J2, J2, d, p, c, e) << std::endl;
                                                }
                                            }
                                        }
                                    }
                            ...
                            for (auto &d : Z.modelspace->all_orbits)
                            {
                                ...
                                if (delta_jhjd)
                                    for (int J2 = j2min; J2 <= j2max; J2++)
                                    {
                                        ...
                                        {
                                            std::cout << " Ib " << occfactor * (2 * J2 + 1) / denominator_h * Eta.TwoBody.GetTBME_J(J2, a, d, b, c) * Eta.TwoBody.GetTBME_J(J2, b, c, a, h) * Gamma.TwoBody.GetTBME_J(J0, p, g, q, d) << std::endl;
                                        }
                                    }
                            }
                        }
                            ...
                            for (auto &d : Z.modelspace->all_orbits)
                            {
                                ...
                                if (delta_jhjd)
                                    for (int J2 = j2min; J2 <= j2max; J2++)
                                    {
                                        ...
                                        if (ch == 0 and ibra == 2 and iket == 4)
                                        {
                                            std::cout << " IVa " << -occfactor * (2 * J2 + 1) / denominator_h * Eta.TwoBody.GetTBME_J(J2, b, c, a, h) * Eta.TwoBody.GetTBME_J(J0, p, g, q, d) * Gamma.TwoBody.GetTBME_J(J2, a, d, b, c) << std::endl;
                                        }
                                    }
                                ...
                                for (int J2 = j2min; J2 <= j2max; J2++)
                                {
                                    for (int J3 = j3min; J3 <= j3max; J3++)
                                    {
                                        for (int J4 = j4min; J4 <= j4max; J4++)
                                        {
                                            ...
                                            if (ch == 0 and ibra == 2 and iket == 4)
                                            {
                                                std::cout << " IIa " << -phase_pg * occfactor * sixj1 * sixj2 * sixj3 * (2 * J2 + 1) * (2 * J3 + 1) * (2 * J4 + 1) * Eta.TwoBody.GetTBME_J(J2, c, p, d, b) * Eta.TwoBody.GetTBME_J(J3, g, b, c, a) * Gamma.TwoBody.GetTBME_J(J0, d, a, q, h) << std::endl;
                                            }
                                        }
                                    }
                                }
                                    ...
                                    for (int J3 = j3min; J3 <= j3max; J3++)
                                    {
                                        for (int J4 = j4min; J4 <= j4max; J4++)
                                        {
                                            ...
                                            for (int J5 = j5min; J5 <= j5max; J5++)
                                            {
                                                ...
                                                if (ch == 0 and ibra == 2 and iket == 4)
                                                {
                                                    std::cout << " IIIa " << occfactor * sixj1 * sixj2 * sixj3 * sixj4 * (2 * J2 + 1) * (2 * J3 + 1) * (2 * J4 + 1) * (2 * J5 + 1) * Eta.TwoBody.GetTBME_J(J2, b, p, c, a) * Eta.TwoBody.GetTBME_J(J3, g, c, h, d) * Gamma.TwoBody.GetTBME_J(J4, d, a, b, q) << std::endl;
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    for (int J3 = j3min; J3 <= j3max; J3++)
                                    {
                                        for (int J4 = j4min; J4 <= j4max; J4++)
                                        {
                                            ...
                                            for (int J5 = j5min; J5 <= j5max; J5++)
                                            {
                                                ...
                                                if (ch == 0 and ibra == 2 and iket == 4)
                                                {
                                                    std::cout << " IIIa " << phase_qh * occfactor * sixj1 * sixj2 * sixj3 * sixj4 * (2 * J2 + 1) * (2 * J3 + 1) * (2 * J4 + 1) * (2 * J5 + 1) * Eta.TwoBody.GetTBME_J(J2, b, p, c, a) * Eta.TwoBody.GetTBME_J(J3, g, c, q, d) * Gamma.TwoBody.GetTBME_J(J4, d, a, b, h) << std::endl;
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    for (int J3 = j3min; J3 <= j3max; J3++)
                                    {
                                        for (int J4 = j4min; J4 <= j4max; J4++)
                                        {
                                            ...
                                            for (int J5 = j5min; J5 <= j5max; J5++)
                                            {
                                                ...
                                                if (ch == 0 and ibra == 2 and iket == 4)
                                                {
                                                    std::cout << " IIIa " << phase_pg * occfactor * sixj1 * sixj2 * sixj3 * sixj4 * (2 * J2 + 1) * (2 * J3 + 1) * (2 * J4 + 1) * (2 * J5 + 1) * Eta.TwoBody.GetTBME_J(J2, b, g, c, a) * Eta.TwoBody.GetTBME_J(J3, p, c, h, d) * Gamma.TwoBody.GetTBME_J(J4, d, a, b, q) << std::endl;
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    for (int J3 = j3min; J3 <= j3max; J3++)
                                    {
                                        for (int J4 = j4min; J4 <= j4max; J4++)
                                        {
                                            ...
                                            for (int J5 = j5min; J5 <= j5max; J5++)
                                            {
                                                ...
                                                if (ch == 0 and ibra == 2 and iket == 4)
                                                {
                                                    std::cout << " IIIa " << phase_pg * phase_qh * occfactor * sixj1 * sixj2 * sixj3 * sixj4 * (2 * J2 + 1) * (2 * J3 + 1) * (2 * J4 + 1) * (2 * J5 + 1) * Eta.TwoBody.GetTBME_J(J2, b, g, c, a) * Eta.TwoBody.GetTBME_J(J3, p, c, q, d) * Gamma.TwoBody.GetTBME_J(J4, d, a, b, h) << std::endl;
                                                }
                                            }
                                        }
                                    }
