...
class IMSRGSolver
{
  ...
  public:
    ...
    {
      public:
        ODE_Monitor(IMSRGSolver &solver) : imsrgsolver(solver), times(solver.times), E0(solver.E0), eta1(solver.eta1), eta2(solver.eta2) {};
        ...
        void report()
        {
            ...
            {
                std::cout << times[i] << "  " << E0[i] << "  " << eta1[i] << "  " << eta2[i] << std::endl;
            }
        }
    };
